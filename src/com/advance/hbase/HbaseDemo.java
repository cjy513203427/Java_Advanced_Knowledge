...
public class HbaseDemo {
    ...
    public void testDrop() throws Exception{
        ...
        admin.disableTable("person_info");
        admin.deleteTable("person_info");
        admin.close();
    }
    ...
    public void testPut() throws Exception{
        ...
        Put p = new Put(Bytes.toBytes("person_rk_bj_zhang_000001"));
        p.add("base_info".getBytes(), "name".getBytes(), "gouride".getBytes());
        table.put(p);
        table.close();
    }
    ...
    public void testGet() throws Exception{
        HTable table = new HTable(conf, "person_info");
        Get get = new Get(Bytes.toBytes("person_rk_bj_zhang_000002"));
...
//          result.getValue(family, qualifier);  可以从result中直接取出一个特定的value
    ...
    public void testScan() throws Exception{
        ...
        Scan scan = new Scan(Bytes.toBytes("person_rk_bj_zhang_000001"), Bytes.toBytes("person_rk_bj_zhang_000003"));
    ...
    public void testDel() throws Exception{
        HTable table = new HTable(conf, "person_info");
        Delete del = new Delete(Bytes.toBytes("person_rk_bj_zhang_000002"));
